...
#close_popup{float:right;}
  ...
  </head><body onload='type();'><div style='background:#3a4660;height:70px;' class='icon-bar'><p id='cart'></p><a href='cartdets.php'><i class="fas fa-shopping-cart fa-1x" style='color:#ed8a63;'></i></a></div><div class='cartadd'>add</div><div class='cartdets'>Details</div>
 <?
 error_reporting(0);
 ?>